...
public class PmsBrandServiceImpl implements PmsBrandService {
    ...
    @Override
    public int createBrand(PmsBrand brand){return brandMapper.insertSelective(brand);}
    ...
    @Override
    public int deleteBrand(Long id){return brandMapper.deleteByPrimaryKey(id);}
    ...
    @Override
    public PmsBrand getBrand(Long id){return brandMapper.selectByPrimaryKey(id);}
}
